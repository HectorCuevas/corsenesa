...
{
    public class XMLFactura : IDocumentRegister
    {
        ...
        public String getXML(string XMLInvoice, string XMLDetailInvoce, string path, string fac_num)
        {
            ...
            if (Constants.EXPO)
            {
                XMLFacturaExportacion xMLc = new XMLFacturaExportacion();
                return xMLc.getXML(XMLInvoice, XMLDetailInvoce, path, fac_num);
            }
            else
            {
                ...
                //string myXML = FirmaDocumento.FirmarDocumento_2(Constants.URL_CERTIFICADO, Constants.URL_CERTIFICADO_CONTRASENIA, path, nombre, path);
           ...
           private String getXML()
        {
           ...
           // Frases.Add(Frase2);
            ...
            catch (Exception ex)
            {
                ...
                String path = "C:\\xml\\FACT\\errores.txt";
